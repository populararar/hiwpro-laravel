...
<section class="content-header" style="text-align:center;">
        <ul class="menu">
                ...
                <li><a href="{!! route('reportAdmins.orderReport') !!}" class="active">ข้อมูลการสั่งซื้อ</a></li>
...
<div class="content">
    ...
    <div class="box box-primary col-sm-12">
        ...
        <h2>TOP 10 อีเวนต์ที่มีคนมาสั่งซื้อสินค้ามากที่สุด</h2>
        <div class="mx-auto" >
                <form method="GET" action="{{ route('reportAdmins.orderReport') }}">
